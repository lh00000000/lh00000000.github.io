...
(def talkingtopeople [:section {:id "talkingtopeople"}
                      ...
                      [:ul [:li "piano tuners (obviously). although i've had three failed attempts so far. i am hoping my instructor lou tasciotti will be supportive though"]
                       ...
                       [:li "shannon mattern"]]
                      [:p "we were also supposed to 'Have 1 conversation with someone who does not know about your topic of interest. Video tape this conversation and upload it to your research page.' but it felt rude to bring up my thesis + ask to video-record whenever i went out to meet someone new. so i did chatroulette."]])
(def paperresponse [:section {:id "paperresponse"}
...
(def precedents [:section {:id "precedents"}
                 [:h2 "precedents"]
...
(def experiment [:section {:id "experiment"}
                 [:h2 "\"experiment\""]
