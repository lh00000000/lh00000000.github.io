...
(defn yt-iframe [sizing vid-id]
  [:iframe
   {:src (str "https://www.youtube.com/embed/" vid-id)
...
(defn section-menu [section-titles]
  [:div {:style {:position "sticky"
                 ...
                 :text-align "center"}}
   [:span "("]
   [:h3 {:style {:display "inline"}} [:b "sections: "]]
...
(defn breakout [heightStyle & children]
    [
    :div
    {:style (merge {
         :display "block"
