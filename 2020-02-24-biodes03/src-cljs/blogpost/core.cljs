  ...
  [:div#layout
   [:article#mainarticle
    ...
    [:section
     ...
     [:p [:span "over the week i have struggled to rise to the assignment of “the need to design” a solution, in the realm of food systems or otherwise. What I ended up settling on was a partially “tongue-in-cheek” imagination focused on one, of many (most of which i suspect i will never become appropriately familiar with without a more disciplined commitment to agricultural studies), obstacles towards enthusiasm  that i see across many projects categorized as “biodesign”. because i am pretty late to proposing the project, "]
      [:span [:a {:href "http://luminghao.com/2020-02-21-biodes-proposal2/"} "i am going to simply link to the draft (it will be a “design proposal” (with renders, which, if i have learned anything at itp, are a currency in the realm of “design” more valuable than any other material form)) here and pedantically focus this post on my reading responses."]]]
     [:div
      [:p "week n-2"]
