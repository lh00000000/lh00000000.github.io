...
var Card = function Card(card) {
  ...
  var list = function list(title, items) {
    ...
    }))), words((items || []).join(", ").split(" "), "listItem"), __jsx(Nbsp, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 120,
...
//# sourceMappingURL=index.js.adf8b5243b744b6819a0.hot-update.js.map