  ...
  return _words.reduce(function (l, word) {
    if (word.startsWith("http")) {
      ...
      if (l.length > 0 && lodash__WEBPACK_IMPORTED_MODULE_5___default.a.last(l).type == "span") {
        l[l.length - 1].textContent = l[l.length - 1].textContent + word + __jsx(Nbsp, {
          __self: _this,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 84,
...
var Card = function Card(card) {
  ...
  var list = function list(title, items) {
    ...
    }, "".concat(title, ":"))), words((items || []).join(", ").split(" "), "listItem"), __jsx(Nbsp, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 119,
...
//# sourceMappingURL=index.js.c207e5094fe0a7efd1c5.hot-update.js.map